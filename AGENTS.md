...
- **Dependabot**: creates weekly PRs for npm and GitHub Actions updates targeting `develop`. Dependencies are grouped (npm together, GitHub Actions together). Config in `.github/dependabot.yml`.
